...
export class AiSearchService {
    ...
    filterSearch(request: AiSearchRequest): Observable<ApiResponse<AiFilterSearchResponseData>> {
        return this.http.post<ApiResponse<AiFilterSearchResponseData>>(`${this.apiUrl}/filter-search`, request);
    }
}
